    ...
    <div className="flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30">
      <div className="flex items-center justify-between w-full md:flex-row">
        <Title
          ...
          subtitle="Take advantage of our limited-time offers and special oackages to enhance  your stay and create unforgettable memories."
        />
        <button className=" group flex items-center gap-2 font-medium cursor-pointer max0md:mt-12">
          View All Offers
          <img
        ...
        {exclusiveOffers.map((item) => (
          ...
          >
            ...
            <button className="flex items-center gap-2 font-medium cursor-pointer mt-4 mb-5">
              View Offers
              <img
                className="invert grouo-hover:translate-x-1 transition-all"
                src={assets.arrowIcon}
                alt=""
              />
            </button>
